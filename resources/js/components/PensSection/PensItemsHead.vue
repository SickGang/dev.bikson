<template>
    <div class="goods-list_item col-lg-6 d-flex flex-column p-2">
      ...
      <div class="goods-list_item__info d-flex p-3 flex-column align-items-center">
        ...
        <div class="goods-list_item__info-right mt-3 d-flex">
          <tippy trigger="click" theme="light" interactive="true" zIndex="3" size="large" arrow="true" :duration="[600,600]" :delay="[400,0]">
